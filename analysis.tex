...
%time domain tests don't show any anomaly detections for hot plate - talk about fourier.


%time domain detect anomalies for oven but very few

%I will make fourier plots and talk about these for this section as there seems to be a bigger change in the fourier spectra. 
...
Each index within the data on which anomalous results are flagged up seem to be similar across each method, indicating no speed advantage between them, however, Median Absolute Deviation seems to stop flagging the anomaly before K Means Cluster and Five Sigma. %why?
...
%No anomalies fired after the initial de-greasing (don't need to show figure for this, just mention it).
%After dirt was added, anomalies started showing up.
